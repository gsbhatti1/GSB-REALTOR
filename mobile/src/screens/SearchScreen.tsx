...
const styles = StyleSheet.create({
  ...
  inputWrap: {
    ...
    borderRadius: radius.sm, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.18)',
    paddingHorizontal: spacing.md,
  },
  inputIcon: { fontSize: 15, marginRight: 8 },
  input: { flex: 1, color: colors.white, fontSize: 14, paddingVertical: 11 },
  clearBtn: { padding: 4 },
  clearBtnText: { color: colors.greyLight, fontSize: 16 },
  filterBtn: {
    width: 46, backgroundColor: 'rgba(255,255,255,0.09)',
    borderRadius: radius.sm, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.18)',
    alignItems: 'center', justifyContent: 'center', position: 'relative',
  },
  filterBtnActive: { borderColor: colors.gold, backgroundColor: colors.goldFaded },
  filterIcon: { fontSize: 18, color: colors.greyLight },
  filterBadge: {
  ...
  typeTabText:   { fontSize: 13, color: colors.greyLight, fontWeight: '600' },
  typeTabTextActive: { color: colors.black, fontWeight: '700' },
  ...
  chip:       { paddingHorizontal: 14, paddingVertical: 8, borderRadius: radius.full, backgroundColor: 'rgba(255,255,255,0.08)', borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.18)' },
  chipActive: { backgroundColor: colors.gold, borderColor: colors.gold },
  chipText:   { fontSize: 13, color: colors.greyLight },
