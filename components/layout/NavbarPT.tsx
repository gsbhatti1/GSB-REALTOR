...
export default function NavbarPT() {
  ...
  const navLinks = [
    { href: '/search',       label: 'Buscar Imóveis' },
    { href: '/pt#vender',    label: 'Vender' },
    { href: '/commercial',   label: 'Comercial' },
    { href: '/investor',     label: 'Investimentos' },
  ...
  return (
    <nav style={{
      ...
      <Link href="/pt" style={{ display: 'flex', alignItems: 'center', gap: '12px', textDecoration: 'none' }}>
      ...
      {menuOpen && (
        <div style={{
          ...
          <Link href="/" style={{ color: '#C9A84C', textDecoration: 'none', fontSize: '14px' }}>🇺🇸 Ver em inglês</Link>
