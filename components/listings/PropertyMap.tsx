...
const ZIP_COORDS: Record<string, [number, number]> = {
  ...
  // Murray / Midvale / Taylorsville / Millcreek
  '84107': [-111.8880, 40.6670], '84047': [-111.9080, 40.6270], '84123': [-111.9080, 40.6470],
  '84106': [-111.8680, 40.7070],
  // Cottonwood Heights / Holladay
  '84121': [-111.8280, 40.6570], '84117': [-111.8280, 40.6870],
  // St George
