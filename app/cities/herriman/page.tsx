...
export const metadata: Metadata = {
  title: 'Homes for Sale in Herriman, Utah | GSB Realtor',
  description:
    "Search homes for sale in Herriman, Utah. Population ~60,000, fast-growing suburb with median home price ~$500K. New construction and great for families. Expert guidance from Gurpreet Bhatti, REALTOR\u00ae.",
  alternates: { canonical: 'https://gsbrealtor.com/cities/herriman' },
}
      ...
      <main style={{ paddingTop: '72px', background: '#0A0A0A', minHeight: '100vh' }}>
        <section style={{
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ marginBottom: '28px', fontSize: '13px', color: '#555', display: 'flex', gap: '8px', alignItems: 'center' }}>
              ...
              <span>/</span>
              <span style={{ color: '#888' }}>Herriman</span>
            </div>
            <h1 style={{
            ...
            <p style={{ fontSize: '17px', color: '#888', lineHeight: '1.8', maxWidth: '680px' }}>
              Herriman is one of Utah&apos;s fastest-growing suburbs with a population of approximately 60,000.
              Located in southwestern Salt Lake County, Herriman features abundant new construction, top-rated
              schools, and family-friendly master-planned communities. The median home price is approximately
              $500,000, offering modern living with mountain views.
            </p>
          </div>
        </section>
        ...
        <section style={{ padding: '64px 32px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '48px' }}>
              <Link href="/search?city=Herriman" style={{
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              {['Riverton', 'South Jordan', 'Bluffdale'].map(city => (
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "name": "GSB Realtor \u2014 Herriman",
            "description": "Expert real estate services in Herriman, Utah. Buy or sell homes with Gurpreet Bhatti, licensed REALTOR\u00ae.",
            "url": "https://gsbrealtor.com/cities/herriman",
