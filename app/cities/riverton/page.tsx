...
export const metadata: Metadata = {
  title: 'Homes for Sale in Riverton, Utah | GSB Realtor',
  description:
    "Search homes for sale in Riverton, Utah. Population ~45,000, suburban community with median home price ~$480K. Top-rated schools and quiet neighborhoods. Expert guidance from Gurpreet Bhatti, REALTOR\u00ae.",
  alternates: { canonical: 'https://gsbrealtor.com/cities/riverton' },
}
      ...
      <main style={{ paddingTop: '72px', background: '#0A0A0A', minHeight: '100vh' }}>
        <section style={{
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ marginBottom: '28px', fontSize: '13px', color: '#555', display: 'flex', gap: '8px', alignItems: 'center' }}>
              ...
              <span>/</span>
              <span style={{ color: '#888' }}>Riverton</span>
            </div>
            <h1 style={{
            ...
            <p style={{ fontSize: '17px', color: '#888', lineHeight: '1.8', maxWidth: '680px' }}>
              Riverton is a well-established suburban community in Salt Lake County with a population of
              approximately 45,000. Known for its top-rated schools, quiet residential neighborhoods, and
              strong sense of community, Riverton is a top choice for families. The median home price is
        ...
        <section style={{ padding: '64px 32px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '48px' }}>
              <Link href="/search?city=Riverton" style={{
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              {['Herriman', 'South Jordan', 'Bluffdale'].map(city => (
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "name": "GSB Realtor \u2014 Riverton",
            "description": "Expert real estate services in Riverton, Utah. Buy or sell homes with Gurpreet Bhatti, licensed REALTOR\u00ae.",
            "url": "https://gsbrealtor.com/cities/riverton",
