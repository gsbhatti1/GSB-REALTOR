...
export const metadata: Metadata = {
  title: 'Homes for Sale in Lehi, Utah | GSB Realtor',
  description:
    "Search homes for sale in Lehi, Utah. Population ~90,000, the heart of Silicon Slopes tech hub with median home price ~$550K. Adobe and Microsoft campuses nearby. Expert guidance from Gurpreet Bhatti, REALTOR\u00ae.",
  alternates: { canonical: 'https://gsbrealtor.com/cities/lehi' },
}
      ...
      <main style={{ paddingTop: '72px', background: '#0A0A0A', minHeight: '100vh' }}>
        <section style={{
          ...
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ marginBottom: '28px', fontSize: '13px', color: '#555', display: 'flex', gap: '8px', alignItems: 'center' }}>
              ...
              <span>/</span>
              <span style={{ color: '#888' }}>Lehi</span>
            </div>
            <h1 style={{
              ...
              Lehi Utah Real Estate
            </h1>
            <p style={{ fontSize: '17px', color: '#888', lineHeight: '1.8', maxWidth: '680px' }}>
              Lehi is the heart of Utah&apos;s &quot;Silicon Slopes&quot; tech corridor with a population of approximately
              90,000. Home to major campuses from Adobe, Microsoft, and dozens of tech startups, Lehi attracts
              young professionals and families seeking modern amenities and strong job growth. The median home
              price is approximately $550,000.
            </p>
          </div>
        </section>
        ...
        <section style={{ padding: '64px 32px' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginBottom: '48px' }}>
              <Link href="/search?city=Lehi" style={{
            ...
            <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              {['Bluffdale', 'Draper', 'Provo'].map(city => (
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            "name": "GSB Realtor \u2014 Lehi",
            "description": "Expert real estate services in Lehi, Utah. Buy or sell homes with Gurpreet Bhatti, licensed REALTOR\u00ae.",
            "url": "https://gsbrealtor.com/cities/lehi",
