...
function generateFallback(type: string, data?: Record<string, unknown>): SocialContent {
  ...
  const base = {
    ...
    sold: {
      ...
      twitter: `🎉 SOLD! ${d.address || 'Another Utah home closed'}! ${d.story ? d.story.substring(0, 80) : 'Congrats to our amazing clients'}. Thinking of selling? 801-635-8462 gsbrealtor.com`,
