...
function getFallbackContent(type: string, data: Record<string, unknown>): SocialContent {
  ...
  return {
    ...
    twitter: `💡 ${dayOfWeek} tip: ${d.point || 'Get pre-approved before you tour homes'}. ${d.topic ? String(d.topic || '').substring(0, 60) : 'Most buyers learn this lesson the hard way'}. 801-635-8462 gsbrealtor.com`,
